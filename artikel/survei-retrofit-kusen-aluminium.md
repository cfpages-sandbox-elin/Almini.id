---
article_id: ALM-07-A05
title: "Survei dan Retrofit Kusen Aluminium pada Bukaan Lama"
slug: "survei-retrofit-kusen-aluminium"
description: "Define opening geometry, substrate, moisture, existing sealant, hidden anchors/services, floor/ceiling movement, access, protection, tolerances, and handover evidence"
status: outline
publication_date: "2026-03-02"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: ALM-07
primary_intent: "Measure and de-risk an opening retrofit"
reader_community: "Almini.id"
reader_address: "Kawan Almini.id"
final_route: "/artikel/survei-retrofit-kusen-aluminium.html"
...
# Survei dan Retrofit Kusen Aluminium pada Bukaan Lama

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Survei dan Retrofit Kusen Aluminium pada Bukaan Lama”
- **Reader and situation:** Renovation team replacing existing frames
- **Reader outcome:** Define opening geometry, substrate, moisture, existing sealant, hidden anchors/services, floor/ceiling movement, access, protection, tolerances, and handover evidence
- **Primary intent:** Measure and de-risk an opening retrofit
...
- **Scope boundary:** Excludes structural alterations and universal installation gaps; ALM-05-A05 owns structural retrofit and project details govern
- **Final public route:** `/artikel/survei-retrofit-kusen-aluminium.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Survei dan Retrofit Kusen Aluminium pada Bukaan Lama**.
...
- **Exact Markdown to insert:** `![Ilustrasi Jasa Kusen Aluminium](/wp-content/uploads/2026/05/Jasa-Kusen-Aluminium.jpeg)`
- **Caption/credit:** Aset lokal proyek; jangan klaim sebagai dokumentasi proyek tertentu.
- **Selection basis:** filename/source metadata identifies `Jasa Kusen Aluminium` as relevant content media; no pixels were inspected.
...
- `/kusen-pintu-partisi-aluminium-yogyakarta.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kusen-pintu-partisi-aluminium-yogyakarta-2.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kusen-pintu-partisi-aluminium-yogyakarta-2` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kusen-pintu-partisi-aluminium-yogyakarta` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kusen-pintu-partisi-aluminium-yalimo.html` — use only if it helps the reader's next step; verify the anchor describes the destination.
- `/kusen-pintu-partisi-aluminium-yalimo` — use only if it helps the reader's next step; verify the anchor describes the destination.

### Planned sibling articles

These are future routes. Do not link them as live until their HTML exists.

- `ALM-07-A03` → `/artikel/kaca-dan-aluminium-dalam-satu-sistem.html` — Pertemuan Kaca dan Aluminium: Setting Block, Gasket, Sealant, dan Tepi Kaca
...
- `ALM-07-A06` → `/artikel/diagnosis-pintu-jendela-aluminium.html` — Pintu Seret, Jendela Bocor, Kaca Bergetar: Diagnosis Sistem Aluminium
...
- **Tie back to this article:** Keep the explanation specific to “Survei dan Retrofit Kusen Aluminium pada Bukaan Lama”.
